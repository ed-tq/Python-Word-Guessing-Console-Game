...
```{=html}
<div class="py-links">
<a href="https://www.w3schools.com/python/python_variables.asp#:~:text=Creating%20Variables" target="_blank" class="py-link" style="text-decoration: none; background: #e8f2fb; color: #1a5a8a; border-radius: 4px; padding: 2px 8px; border: 1px solid #bcd9f0; font-family: Consolas, monospace; font-size: 0.78em;">Variables 🔗</a>
<a href="https://www.w3schools.com/python/python_user_input.asp#:~:text=Using%20prompt" target="_blank" class="py-link" style="text-decoration: none; background: #e8f2fb; color: #1a5a8a; border-radius: 4px; padding: 2px 8px; border: 1px solid #bcd9f0; font-family: Consolas, monospace; font-size: 0.78em;">User Input 🔗</a>
<a href="https://www.w3schools.com/python/ref_func_print.asp" target="_blank" class="py-link" style="text-decoration: none; background: #e8f2fb; color: #1a5a8a; border-radius: 4px; padding: 2px 8px; border: 1px solid #bcd9f0; font-family: Consolas, monospace; font-size: 0.78em;">print() 🔗</a>
<a href="https://www.w3schools.com/python/python_string_formatting.asp#:~:text=Placeholders%20and%20Modifiers" target="_blank" class="py-link" style="text-decoration: none; background: #e8f2fb; color: #1a5a8a; border-radius: 4px; padding: 2px 8px; border: 1px solid #bcd9f0; font-family: Consolas, monospace; font-size: 0.78em;">String Formatting 🔗</a>
</div>
```
