...
```{=html}
<div class="py-links">
  <a href="https://www.w3schools.com/python/python_modules.asp#:~:text=Use%20a%20Module" target="_blank" class="py-link" style="text-decoration: none; background: #e8f2fb; color: #1a5a8a; border-radius: 4px; padding: 2px 8px; border: 1px solid #bcd9f0; font-family: Consolas, monospace; font-size: 0.78em;">Modules 🔗</a>
</div>
```
...
This lets us select random words from our `words.txt` file using functions like `random.choice(...)`
</details>
</div>
...
To use all functions from a module: <code>import moduleName</code>
</div>
</details>
</div>
...
<div style="margin: 20px auto; margin-bottom: 0; margin-top: 0; padding: 20px;">
  ...
  <p style="font-size:15px;"><b>Note:</b> Make sure to save your code in your <code>script.py</code> file.</p>
